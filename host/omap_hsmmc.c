				  ...
				  int vdd)
{
	...
	if (power_on)
	{	
		pr_info("flc222 power_on");
		ret = mmc_regulator_set_ocr(host->mmc, host->vcc, vdd);
	}
	else
	{
                pr_info("flc222 power_off");
...
static void omap_hsmmc_set_ios(struct mmc_host *mmc, struct mmc_ios *ios)
{
	...
	pm_runtime_get_sync(host->dev);
	pr_info("flc222 omap_hsmmc_set_ios");
	pr_info("flc222 ios->power_mode=%d",ios->power_mode);
	/*
